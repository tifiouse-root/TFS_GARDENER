...
Keys = {
    ...
    ['TAB'] = 37, ['Q'] = 44, ['W'] = 20, ['E'] = 38, ['R'] = 45, ['T'] = 245, ['Y'] = 246, ['U'] = 303, ['P'] = 199, ['['] = 39, [']'] = 40, ['ENTER'] = 18,
...
--Config.Payout = math.random(300, 800) si tu veux un payement aléatoire
Config.CompanyVehicle = "burrito3"
Config.DepositPrice = 1000
Config.Gardener = {
    Base = {
		Pos   = {x = -428.6341, y = -1728.2013, z = 19.7838},
		Size  = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 255, g = 165, b = 0},
		Type  = 27,
        BlipSprite = 140,
        BlipLabel = '~g~Entreprise~s~ | Lost Books',
        BlipColor = 2,
        BlipScale = 0.8,
	},
    Garage = {
        Pos   = {x = -469.0924, y = -1719.7052, z = 18.6826},
		Size  = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 255, g = 165, b = 0},
		Type  = 27,
        BlipSprite = 524,
        BlipLabel = '~g~Entreprise~s~ | Garage',
        BlipColor = 2,
        BlipScale = 0.5,
	},
    GarageSpawnPoint = {
		Pos1   = {x = -466.6019, y = -1720.9008, z = 18.6333, h = 284.7904},
        Pos2   = {x = -468.0552, y = -1717.5607, z = 18.6891, h = 282.2917},
	},
    DefaultMarker = {
		Size  = {x = 1.2, y = 1.2, z = 1.0},
        Color = {r = 255, g = 165, b = 0},
